...
export const MainNavbar = () => {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 px-8  bg-white border-b border-[#9e9e9e8f]">
      <div className="max-w-7xl mx-auto flex items-center justify-between py-5">
        ...
        <div className="flex items-center gap-3 text-sm">
          ...
          <Link
            to="/login"
            className="text-onBackground hover:text-primary transition-colors px-4 py-2 rounded hover:bg-[#E8E8E8]"
          >
            Log in
          </Link>
          <Link to="/signup">
